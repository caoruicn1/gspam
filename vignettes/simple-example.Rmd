...
We can see that while the sign of the fits is mostly the same, the actual values are quite different. This suggests that we should use cross-validation in most cases for this method, rather than picking a random lambda on the solution path.
