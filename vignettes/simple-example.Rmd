...
```{r}
y_quad <- example_data[c(1:990),104]
y_log <- example_data[c(1:990),103]
true_signal <- example_data[,102]
x <- example_data[c(1:990),c(-102,-103,-104)]

test_y_quad <- example_data[c(991:1000),104]
test_y_log <- example_data[c(991:1000),103]
test_x <- example_data[c(991:1000),c(-102,-103,-104)]
```
